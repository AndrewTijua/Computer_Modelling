...
def main():
    ...
    print("\nv_2 = {0}, |v_2| = {1}".format(vec_2, linalg.norm(vec_2)))
    print("\nv_3 = {0}, |v_3| = {1}".format(vec_3, linalg.norm(vec_3)))
    ...
    print("v_1 x v_2 = {0}".format(numpy.cross(vec_1, vec_2)))
    print("\n-v_2 x v_1 = {0}".format(-1 * numpy.cross(vec_2, vec_1)))
    #prints out identities

    print("\nSecond Identity:")
    print("v_1 x (v_2 + v_3) = {0}".format(numpy.cross(vec_1, vec_2 + vec_3)))
    print("\n(v_1 x v_2) + (v_1 x v_3) = {0}".format(numpy.cross(vec_1, vec_2) + numpy.cross(vec_1, vec_3)))
    #prints out identities

    print("\nThird Identity:")
    print("v_1 x (v_2 x v_3) = {0}".format(numpy.cross(vec_1, numpy.cross(vec_2, vec_3))))
